...
if (isset($_POST['submit'])) {
    ...
    if (!empty($nom) && !empty($description)  && !empty($quantite) && !empty($prix) && !empty($image) ) {
        ...
        $req = "INSERT INTO `produit`(`nomProduit`,`description`,`quantite`,`prix`,`image`) VALUES (?,?,?,?,?)";
        $statement = $db->prepare($req);
        $statement->execute(array($nom,$description, $quantite, $prix,$new_file_name));
      ...
      <div class="col-xl-6 col-lg-9 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-5">
            ...
            <h5 class=" text-center text-bold">Ajout d'un produit</h5>
            <hr>
            ...
            <form class="form-signin" action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" required class="form-control" name="prix">
              </div>
              ...
              <button id="submit" class="btn btn-lg btn-block " name="submit" style="background-color:#42a5f5;" type="submit"><span style="color:white;">Ajout </span></button>
